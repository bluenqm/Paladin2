...
class TextClassifier():
    ...
    def evaluate(self, dev_df):
        ...
        for col in column_names:
            ...
            logging.warning('precision: {}'.format(precision))
            logging.warning('recall: {}'.format(recall))
            logging.warning('fscore: {}'.format(fscore))
            logging.warning('support: {}'.format(support))
